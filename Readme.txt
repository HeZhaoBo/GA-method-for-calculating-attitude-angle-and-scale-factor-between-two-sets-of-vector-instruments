...
Note: This program is based on Matlab's genetic algorithm toolbox. The main and objective functions are customized to achieve the 
optimization search problem of the relative attitude angle and the scale factor between two sets of vector instruments.
